...
//                System.out.println("Ticket is already booked with this user\nDo you want to book with this user again ? (Y/N) : ");
//                String ans = sc.next();
//                if(ans.equals("N")) {
//                    return;
//                }
...
//            String query4_2 = "set @new_booking_id = 0;\n" +
//                    "UPDATE bookings SET booking_id = booking_id - (SELECT COUNT(*) FROM bookings b WHERE b.booking_id < bookings.booking_id);";
//            String query4_3 = "alter table bookings auto_increment = 1";

            PreparedStatement pstmt4_1 = conn.prepareStatement(query4_1);
//            PreparedStatement pstmt4_2 = conn.prepareStatement(query4_2);
//            PreparedStatement pstmt4_3 = conn.prepareStatement(query4_3);
...
//            String query5_2 = "set @new_user_id = 0;\n" +
//                    "UPDATE users SET user_id = user_id - (SELECT COUNT(*) FROM users u WHERE u.user_id < users.user_id)";
//            String query5_3 = "alter table users auto_increment = 1";

            PreparedStatement pstmt5_1 = conn.prepareStatement(query5_1);
//            PreparedStatement pstmt5_2 = conn.prepareStatement(query5_2);
//            PreparedStatement pstmt5_3 = conn.prepareStatement(query5_3);
